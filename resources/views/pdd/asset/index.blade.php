                    ...
                    <x-frontend.card>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                    ...
                                    <a href="{{route('asset.create')}}" class="btn btn-outline-info" id="exportBtn">@lang('Create')</a>
                        ...
                        <x-slot name="body">
                            ...
                            @foreach($items as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('asset.show', $item->id) }}"><i class="fas fa-eye">Show</i></a>
                                 
                                            <a href="{{ route('asset.edit', $item->id) }}"><i class="fas fa-edit">Edit</i></a>
